...
- OS: <!-- macOS / Linux distro / WSL -->
- `python3 --version`:
- Installed deps? (`pip install -r requirements.txt` succeeded?): yes / no

### Logs / error

```
paste any traceback or terminal output (REDACT any keys — never paste your .env or wallet)
```
