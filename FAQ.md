...
[Telegram](https://t.me/pipboi), or [open a question issue](../../issues/new/choose).
...
*hard*, and on free data it's frequently unproven. PIPBOI is built to be honest
...
### Is $PIPBOI a good investment? Is it a rug?

`$PIPBOI` is a **community token / flag** for an open-source project — **not a fund,
...
There is exactly **one** official $PIPBOI:

```
59E8gLC4Zuh1zdfiTsoV7zMgoMBtHcnyGkfb58s4pump
```

Always verify it against the [official site](https://onasidequestt.github.io/pipboi/)
...
reasons it's skipping. If something's actually wrong, run **`./pipboi doctor`** — it
checks your Python, dependencies, keys, wallet, and port and tells you the one
thing to fix.

### How do I get help?

1. **`./pipboi doctor`** — the built-in checkup.
2. **Your own Claude** — open the repo in Claude Code and ask; `CLAUDE.md` makes it
   a co-pilot for this exact codebase.
3. **[Telegram](https://t.me/pipboi)** or **[a GitHub issue](../../issues/new/choose)**.

### Is this affiliated with Anthropic or Solana?

No. PIPBOI is an independent, open-source community project. It's *built to be
